        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 p-4 md:p-6 lg:p-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-stretch">
                    ...
                    <div className="animate-slideInLeft h-full">
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-3xl h-full flex flex-col">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 md:p-8 flex-1 flex flex-col">
                                {/* Success Message */}
                                {submitSuccess && (
                                    <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg animate-slideInDown flex items-center space-x-2">
                                ...
                                {/* Error Message */}
                                {error && (
                                    <div className="mb-6 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg animate-slideInDown">
                                        {error}
                                    </div>
                                )}
                    ...
                    <div className="animate-slideInRight h-full">
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-3xl h-full flex flex-col">
                            {/* Info Header */}
                                ...
                                <div className="space-y-6 flex-1 flex flex-col">
                                    ...
                                    <div className="flex items-start space-x-4 animate-slideUp" style={{ animationDelay: '0.2s' }}>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <a href="tel:+918767826599" className="text-gray-600 text-sm hover:text-green-600 transition-colors duration-300">
                                                +91 8767826599
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start space-x-4 animate-slideUp" style={{ animationDelay: '0.3s' }}>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <a href="mailto:info@ishavai.com" className="text-gray-600 text-sm hover:text-green-600 transition-colors duration-300">
                                                info@ishavai.com
                                            </a>
                                        </div>
                                    </div>
