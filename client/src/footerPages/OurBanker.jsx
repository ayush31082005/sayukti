...
const OurBanker = () => {
    ...
    const bankDetails = [
        { label: 'Bank Name', value: 'AUSMALL FINANCE BANK', icon: Building2, color: 'from-green-600 to-emerald-500' },
        { label: 'A/C Number', value: '2121236733405621', icon: CreditCard, color: 'from-green-500 to-teal-500' },
        { label: 'A/C Name', value: 'ISHAAVIA GLOBAL MARKETING', icon: User, color: 'from-emerald-600 to-green-500' },
        { label: 'Branch Name', value: 'Chandrapur', icon: MapPin, color: 'from-teal-500 to-green-400' },
        { label: 'IFSC Code', value: 'AUBL0002367', icon: QrCode, color: 'from-green-700 to-emerald-600' },
    ];
